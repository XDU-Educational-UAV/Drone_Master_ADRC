...
#define DegToGyro(x)          ((short)((x)*131.072f))  //(x*2^15/250)
#define DegToPwmAdd(x)        ((x)/9.0f*50.0f+500)
#define DegToPwm(x)           ((x)/9.0f*50.0f)
#define GyroToDeg(x)          ((float)(x)*0.0076293945f)  //(x*250/2^15)
#define GyroToRad(x)          ((float)(x)*1.331580545e-4f)
...
#define RadToGyro(x)          ((short)((x)*7509.8724f))  //(x*2^15/250*57.3)
